    ...
    config: {
        ...
        items: [{
            ...
            tpl: new Ext.XTemplate(
                ...
                '<div class="list">',
                '<div class="img">',
                '<img src="{[WeiQuPai.Util.getAvatar(values.pic_cover, 140)]}" width="130">',
                '</div>',
                '<div class="price">',
                '<div class="left">原价:{oprice}</div>',
                '<div class="right">低价:{oprice}</div>',
                '<div class="clear"></div>',
                '</div>',
                ...
                '<div class="dis">',
                '<span id="yipai_price">',
                '{nick}<span style="color:#e76049"> {curr_price}</span>',
                '</div>',
                '</tpl>',
